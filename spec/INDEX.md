...
| [ARC-4601](ARC-4601.md) | Agent Node Protocol (§1-§15 IMPL, §15.14 Session Resumption DRAFT, §16 P2P DRAFT, §18 amendment DRAFT) | RFC 4601 (PIM-SM), RFC 6455 (WebSocket) | 3GPP TS 23.501 NF lifecycle; PIM-SM rendezvous point; Hub server (§15, BR-018); Noise IK (§16); ATR-Q.931 §7.4 hub-side companion (§18); session resumption amendment (§15.14) | IMPLEMENTED | Extension |
...
| [AES-7531](AES-7531.md) | Immersive Shell — Master Control Board | -- (Original) | SPECBOOT slash command lifecycle (LIDR); Textual TUI framework; vim modal model | DRAFT | Extension |
